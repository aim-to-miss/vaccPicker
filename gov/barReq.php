                      ...
                      <div class="card-body">
                          <div class="row">
                              <div class="col-6 col-md-3 text-center">
                                  ...
                                  <div class="knob-label">Barishal</div>
                              </div>
                              <div class="col-6 col-md-3 text-center">
                                  ...
                                  <div class="knob-label">Barguna</div>
                              </div>
                              <div class="col-6 col-md-3 text-center">
                                  <input type="text" class="knob" value="40" data-skin="tron" data-thickness="0.2" data-width="120"
                                         data-height="120" data-fgColor="orange" readonly disabled>

                                  <div class="knob-label">Bhola</div>
                              </div>
                              <div class="col-6 col-md-3 text-center">
                                  <input type="text" class="knob" value="100" data-skin="tron" data-thickness="0.2" data-width="120"
                                         data-height="120" data-fgColor="red" readonly disabled>

                                  <div class="knob-label">Jhalokati</div>
                              </div>
                              <div class="col-6 col-md-3 text-center">
                                  <input type="text" class="knob" value="40" data-skin="tron" data-thickness="0.2" data-width="120"
                                         data-height="120" data-fgColor="orange" readonly disabled>

                                  <div class="knob-label">Patuakhali</div>
                              </div>
                              <div class="col-6 col-md-3 text-center">
                                  <input type="text" class="knob" value="100" data-skin="tron" data-thickness="0.2" data-width="120"
                                         data-height="120" data-fgColor="red" readonly disabled>

                                  <div class="knob-label">Pirojpur</div>
                              </div>
                          </div>
                          <!-- /.row -->
                      </div>
...
<script>
    $(function () {
        ...
        var areaChartData = {
            labels  : ['Barishal', 'Bargona', 'Bhola', 'Jhalokati', 'Pirojpur', 'Patuakhali'],
            datasets: [
                {
                    ...
                    data                : [5.546, 6.139, 5.715, 15.017, 6.210, 13.44]
                }
            ]
        }
